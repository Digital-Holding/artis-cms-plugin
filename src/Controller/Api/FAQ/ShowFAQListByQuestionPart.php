...
final class ShowFAQListByQuestionPart
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $questionPhrase = $request->attributes->get('phrase');

        /** @var ArrayCollection|FrequentlyAskedQuestionInterface[] $frequentlyAskedQuestions */
        $frequentlyAskedQuestions = $this->frequentlyAskedQuestionRepository->findByQuestionPart(
            $questionPhrase,
            $localeCode
        );
